...
INSERT INTO `pma__central_columns` VALUES ('testes','email','varchar','255','latin1_swedish_ci',0,',','');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Saved export templates';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pma__recent` VALUES ('root','[{\"db\":\"Projeto_01\",\"table\":\"tb_admin.online\"},{\"db\":\"Projeto_01\",\"table\":\"tb_admin.usuarios\"},{\"db\":\"erp\",\"table\":\"cursos\"},{\"db\":\"testes\",\"table\":\"clientes\"},{\"db\":\"db_teste\",\"table\":\"clientes\"},{\"db\":\"modulo_8\",\"table\":\"clientes\"},{\"db\":\"erp\",\"table\":\"cadastros\"},{\"db\":\"erp\",\"table\":\"produtos\"},{\"db\":\"erp\",\"table\":\"pedidos\"},{\"db\":\"db_teste\",\"table\":\"cargos\"}]');
...
INSERT INTO `pma__table_uiprefs` VALUES ('root','testes','clientes','[]','2020-02-04 22:16:13');
...
INSERT INTO `pma__userconfig` VALUES ('root','2020-01-26 13:56:56','{\"lang\":\"pt_BR\",\"collation_connection\":\"utf8mb4_unicode_ci\",\"ThemeDefault\":\"pmahomme\"}');
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `testes` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `testes`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
...
INSERT INTO `clientes` VALUES (1,'Guilherme','contato@dankicode.com','2017-11-08'),(2,'Fernando','fernando@dankicode.com','2017-11-20\r\n'),(3,'Giu','giu@dankicode.com','2017-11-15');
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `interacaopython` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `interacaopython`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
-- Host: localhost    Database: interacaopython
-- ------------------------------------------------------
-- Server version	5.7.29-0ubuntu0.18.04.1
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-10-29 23:38:28',NULL),('diagnostics.include_raw','OFF','2019-10-29 23:38:28',NULL),('ps_thread_trx_info.max_length','65535','2019-10-29 23:38:28',NULL),('statement_performance_analyzer.limit','100','2019-10-29 23:38:28',NULL),('statement_performance_analyzer.view',NULL,'2019-10-29 23:38:28',NULL),('statement_truncate_len','64','2019-10-29 23:38:28',NULL);
...
LOCK TABLES `clientes` WRITE;
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
INSERT INTO `clientes` VALUES (1,'Guilherme',1),(2,'João',1),(3,'Felipe',2),(4,'Lucas',2);
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `cursopython3` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `cursopython3`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
-- Host: localhost    Database: cursopython3
-- ------------------------------------------------------
-- Server version	5.7.29-0ubuntu0.18.04.1
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `python3` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `python3`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
-- Host: localhost    Database: python3
-- ------------------------------------------------------
-- Server version	5.7.29-0ubuntu0.18.04.1
...
LOCK TABLES `cadastros` WRITE;
/*!40000 ALTER TABLE `cadastros` DISABLE KEYS */;
INSERT INTO `cadastros` VALUES (1,'admin','admin',2),(2,'Dansol','681015',1);
/*!40000 ALTER TABLE `cadastros` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `estatisticaVendido`
--

LOCK TABLES `estatisticaVendido` WRITE;
/*!40000 ALTER TABLE `estatisticaVendido` DISABLE KEYS */;
INSERT INTO `estatisticaVendido` VALUES (1,'suco de laranja','pizzas',7);
/*!40000 ALTER TABLE `estatisticaVendido` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pedidos` VALUES (1,'coca','','bebidas','',''),(2,'pizza de mussarela','mussarela','pizzas','','sem cebola'),(3,'sda','','','',''),(9,'Pizza de Mussarela','Mussarela','Pizzas','Rua Moisés Alves dos Santos, 500','Massa fina e bastante recheio'),(10,'Pizza Napolitana','','','','');
...
INSERT INTO `produtos` VALUES (2,'Pizza Calabresa','Calabresa, Cebola','Pizzas',35),(3,'Pizza mussarela','Mussarela','Pizzas',35),(5,'Coca Cola','','Bebidas',6),(6,'Pizza Napolitana','Mussarela, Tomate, Parmesão','Pizzas',39.9);
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `cursowp` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `cursowp`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
-- Host: localhost    Database: cursowp
-- ------------------------------------------------------
-- Server version	5.7.29-0ubuntu0.18.04.1
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `Projeto_01` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `Projeto_01`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
...
INSERT INTO `tb_admin.usuarios` VALUES (1,'admin','admin','danilo.jpg','Danilo Pacheco',2);
...
INSERT INTO `funcionarios` VALUES ('Marcos','Vendedor',12345),('Marcos','Caixa',123456);
...
INSERT INTO `materiais` VALUES (1,'Mesa','3m','Madeira'),(2,'Mesa','3m','Madeira');
...
LOCK TABLES `pessoas` WRITE;
/*!40000 ALTER TABLE `pessoas` DISABLE KEYS */;
INSERT INTO `pessoas` VALUES ('Caio',24,'08111510','34828711888');
/*!40000 ALTER TABLE `pessoas` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2020-02-18 23:16:53
CREATE DATABASE  IF NOT EXISTS `modulo_8` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `modulo_8`;
-- MySQL dump 10.13  Distrib 5.7.29, for Linux (x86_64)
--
-- Host: localhost    Database: modulo_8
-- ------------------------------------------------------
-- Server version	5.7.29-0ubuntu0.18.04.1
...
INSERT INTO `categorias` VALUES (1,'Geral'),(2,'Esportes');
...
LOCK TABLES `clientes` WRITE;
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
INSERT INTO `clientes` VALUES (2,'Joao','Pereira','2020-01-29 00:00:00'),(3,'Eliana M Augusto','Pereira','2020-02-04 18:44:24'),(4,'Solange ','Pereira','2020-02-04 18:44:56');
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;
UNLOCK TABLES;
